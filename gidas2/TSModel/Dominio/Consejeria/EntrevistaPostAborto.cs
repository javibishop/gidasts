...
namespace TSModel.Dominio.Consejeria
{
    public class EntrevistaPostAborto : EntidadBase
    {
        ...
        public virtual  bool ConsejeriaMACNo { get; set; }
        public virtual  bool ConsejeriaMACACO { get; set; }
        public virtual  bool ConsejeriaMACACI { get; set; }
        public virtual  bool ConsejeriaMACDIU { get; set; }
        public virtual  bool ConsejeriaMACPreservativo { get; set; }
        public virtual  bool ConsejeriaMACImplanteHormonal { get; set; }
    }
}
