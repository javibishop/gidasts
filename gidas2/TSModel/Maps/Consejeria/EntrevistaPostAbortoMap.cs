...
namespace TSModel.Maps.Consejeria
{
    public class EntrevistaPostAbortoMap : ClassMap<EntrevistaPostAborto>
    {
        public EntrevistaPostAbortoMap()
        {
            ...
            Map(x => x.ConsejeriaMACNo);
            Map(x => x.ConsejeriaMACACO);
            Map(x => x.ConsejeriaMACACI);
            Map(x => x.ConsejeriaMACDIU);
            Map(x => x.ConsejeriaMACPreservativo);
            Map(x => x.ConsejeriaMACImplanteHormonal);
        }
    }
}
